...
import {
  ArrowLeft, BookOpen, Move, Shield, Target, Timer, Users, MapPin,
  Sparkles, ShoppingBag, Gift, Skull,
} from 'lucide-react';
      ...
      <div className="space-y-8 text-[#a89078]">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4 leading-relaxed">
            ...
            <li><strong>Csapdák</strong> csak kincsmódban: rejtett mező, ha rálépsz (vagy teleport/cserén átkerülsz oda), <strong>visszakerülsz a saját startmeződre</strong>.</li>
          </ul>
        </section>
          ...
          <div className="overflow-x-auto rounded-lg border border-[#f0c866]/20">
            <table className="w-full text-sm text-left border-collapse">
              ...
              <tbody className="text-[#c8b090]">
                ...
                <tr className="border-b border-white/5"><td className="p-2 font-semibold text-[#f472b6]">Csapda</td><td className="p-2">Csapda az <strong>aktuális</strong> meződön; más játékos rálépve (vagy ide kerülve) <strong>startjára</strong> vissza.</td></tr>
